	...
	<div id="genel">
		...
		<div id="content">
			<div class="content-title">
				<h4>填写招领信息 <span style="color:red">${addMsg}</span></h4>
				<div
					style="border-bottom: 1px solid #ececec; margin: 10px 0px 20px 0px;"></div>
			</div>
			<form action="shop_addTake.action" method="post" enctype="multipart/form-data">
				<table cellspacing="0" cellpadding="0" border="1px">
					<input type="hidden" name="shop.type" value="take"/>
					<tr>
						<td height="50px"><label for="note-title" class="">标题：</label></td>
						<td colspan="3">
							<input type="text" id="note-title" class=""
								name="shop.title" size="90" style="height: 40px;" />
						</td>
					</tr>
					<tr>
						<td height="40px"><label for="note-info-goods">物品种类：</label></td>
						<td>
							<select name="shop.shop_type" id="search-goods-type" style="height: 25px;">
					...
					<tr>
						<td height="40px"><label for="note-info-goods">物品名称：</label></td>
						<td>
						...
						<td>
							...
							name="shop.shop_comment" placeholder="颜色、品牌、卡号、特点？" size="30"
							style="height: 25px;" />
						</td>
					</tr>
					<tr>
						<td height="40px"><label for="datepicker">捡到时间：</label></td>
						<td>
							<input type="text" class="input-icon" id="datepicker"
							name="shop.shop_time" placeholder="yyyy-mm-dd" size="30"
							style="height: 25px;" />
						</td>
						<td><label for="note-info-address">捡到地点：</label></td>
						<td><input type="text" class="input-icon"
							id="note-info-address" name="shop.address" placeholder="明实楼、北配楼、图书馆？"
							size="30" style="height: 25px;" /></td>
					</tr>
					<tr>
						<td height="40px"><label for="note-contact-phone">您的手机：</label></td>
						<td><input type="text" id="note-contact-phone"
